...
import IntroCard from "@/app/(core)/components/apps/userprofile/profile/IntroCard";
import PhotosCard from "@/app/(core)/components/apps/userprofile/profile/PhotosCard";
import Post from "@/app/(core)/components/apps/userprofile/profile/Post";
