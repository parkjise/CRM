...
// packages/typescript/main/src/app/(core)/components/forms/theme-elements/CustomCheckbox.tsx:18
...
const ProductGridList = () => {
  ...
  //Fetch Products
  // React.useEffect(() => {
  //   // const product = fetch("127.0.0.1:8000");
  //
  ...
  React.useEffect(() => {
    // const res = fetch("localhost:8000/");
    setRows(getProducts);
  }, [getProducts]);
