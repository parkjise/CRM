...
// components
import AccountTab from "@/app/(core)/components/pages/account-setting/AccountTab";
import {
  IconArticle,
  IconBell,
  IconLock,
...
import NotificationTab from "@/app/(core)/components/pages/account-setting/NotificationTab";
import BillsTab from "@/app/(core)/components/pages/account-setting/BillsTab";
import SecurityTab from "@/app/(core)/components/pages/account-setting/SecurityTab";
