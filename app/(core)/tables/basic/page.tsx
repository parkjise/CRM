...
import Table2 from "@/app/(core)/components/tables/Table2";
import Table3 from "@/app/(core)/components/tables/Table3";
import Table1 from "@/app/(core)/components/tables/Table1";
import Table4 from "@/app/(core)/components/tables/Table4";
import Table5 from "@/app/(core)/components/tables/Table5";
